      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" style="background-color: yellowgreen; color: white;" href="{{ url('myappointment') }}">My Appoitment</a>
            </li>
  ...
  <div align="center" style="padding:70px;">
    ...
    <table>
        ...
        <tr style="background-color: black;" align="center">
            <td style="padding: 10px; color: white;">{{ $appointment->name }}</td>
            <td style="padding: 10px; color: white;">{{ $appointment->date }}</td>
            <td style="padding: 10px; color: white;">{{ $appointment->message }}</td>
            <td style="padding: 10px; color: white;">{{ $appointment->status }}</td>
            <td><a class="btn btn-danger" onclick="return confirm('Are yout sure to delete it?')" href="{{ url('cancel_appointment',  $appointment->id) }}">Cancel</a></td>
        </tr>
...
<script src="../public/assets/vendor/owl-carousel/js/owl.carousel.min.js"></script>
